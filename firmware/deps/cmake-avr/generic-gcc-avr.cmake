...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   if(NOT TARGET get_status)
      ...
      add_custom_target(
         get_status
         ${AVR_UPLOADTOOL} -p ${AVR_MCU} -c ${AVR_PROGRAMMER} -P ${AVR_UPLOADTOOL_PORT} -n -v ${AVR_UPLOADTOOL_OPTIONS}
         COMMENT "Get status from ${AVR_MCU}"
      )
   endif(NOT TARGET get_status)

   if(NOT TARGET get_fuses)
      # get fuses
      add_custom_target(
         get_fuses
   ...
   endif(NOT TARGET get_fuses)

   if(NOT TARGET set_fuses)
      # set fuses
      add_custom_target(
         set_fuses
   ...
   endif(NOT TARGET set_fuses)

   if(NOT TARGET get_calibration)
   ...
   endif(NOT TARGET get_calibration)

   if(NOT TARGET set_calibration)
   ...
   endif(NOT TARGET set_calibration)
