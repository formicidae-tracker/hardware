...
#define FAN_AGING_THRESHOLD(power) ( 3 * power)
...
#define NB_CONF 11
	uint8_t registers_and_data[2*NB_CONF] = {EMC_CONFIG_REG,0x40,
	                                         ...
	                                         EMC_FAN2_CONF2_REG,  EMC_BASIC_DERIVATIVE | EMC_ERROR_RANGE_50RPM,
	                                         EMC_FAN1_SPIN_UP_REG,EMC_DRIVE_FAIL_COUNT_16 | EMC_ENABLE_KICK | EMC_SPIN_TIME_1000MS | EMC_SPIN_LVL_65,
	                                         EMC_FAN2_SPIN_UP_REG,EMC_DRIVE_FAIL_COUNT_16 | EMC_DISABLE_KICK | EMC_SPIN_TIME_1000MS | EMC_SPIN_LVL_65,
	...
	if (fan2Mult > 1 || fan2Mult == 0) {
		fan2Mult = 2;
		registers_and_data[9] = EMC_DIS_ALGO | EMC_RANGE_1000 | EMC_EDGES_3 | EMC_UPDATE_200MS;
	}
