...
#define EMC_ENABLE_RAMP_RATE_CONTROL (1 << 6)
#define EMC_ENABLE_GLITCH_FILTER ( 1<< 5)
#define EMC_NO_DERIVATIVE ( 0 << 3)
#define EMC_BASIC_DERIVATIVE ( 1 << 3)
#define EMC_STEP_DERIVATIVE ( 2 << 3)
#define EMC_BASIC_AND_STEP_DERIVATIVE ( 3 << 3)
#define EMC_ERROR_RANGE_0RPM ( 0 << 1)
#define EMC_ERROR_RANGE_50RPM ( 1 << 1)
#define EMC_ERROR_RANGE_100RPM ( 2 << 1)
#define EMC_ERROR_RANGE_200RPM ( 3 << 1)
